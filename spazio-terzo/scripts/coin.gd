...
## Valore del petalo quando viene raccolto.
...
## Gravità applicata ai petali droppati dal player.
@export var drop_gravity: float = 1350.0
## Tempo di vita dei petali droppati prima di sparire.
...
func _on_body_entered(body: Node2D) -> void:
	...
	if body.has_method("collect_petal"):
		body.collect_petal(value)
